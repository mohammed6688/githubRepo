...
/**
 * Sample Java code for youtube.subscriptions.insert
...
public class ApiExample {
    private static final String CLIENT_SECRETS= Application.getPrefranceData("CLIENT_SECRETS");
    ...
    public static void main(String[] args)
        ...
        resourceId.setChannelId(Application.getPrefranceData("ChannelId"));
